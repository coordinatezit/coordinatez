...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "How Coordinatez Global Trade collects, uses, and protects personal information submitted through trade.coordinatez.com — including the contact form, analytics, anti-spam protection, data retention, and your rights.",
  path: "/privacy-policy",
  noIndex: false,
});
        ...
        <Container>
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-8 text-pretty text-lg leading-relaxed text-muted-foreground">
              ...
              and protects personal information when you visit trade.coordinatez.com (the
            ...
            <PolicySection title="2. How we use your information">
              <PolicyList
                items={[
                  "To respond to your inquiries and provide information about our trade services.",
            ...
            <PolicySection title="6. Data retention">
              <p>
                ...
                the inquiry. You may request deletion of your information at any time as described
                under &ldquo;Your rights&rdquo; below.
              </p>
            </PolicySection>
            ...
            <PolicySection title="8. International data transfers">
              <p>
                ...
                submit may be accessed and processed by our teams in those countries. Wherever
